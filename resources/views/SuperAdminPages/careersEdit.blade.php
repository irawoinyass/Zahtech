...
@section('content')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                              ...
                              <li class="breadcrumb-item active"><a href="{{route('superadmin.aboutus')}}">Careers</a></li>
 ...
 {{ csrf_field() }}
    ...
    <input type="hidden" name="id" id="id" value="{{$car->careers_id}}">

       <div class="form-group">
          <label style="">Desc</label>
           <textarea class="form-control" id="desc" name="desc" rows="5" cols="">{!! $car->desc !!}</textarea>
         <small style=" font-weight: 700;"></small>
        </div>
...
<div>
    <img class="img-fluid" src="{{asset('assets/images/about/'.$car->image)}}" width="200">
</div>
</div>
...
$('.overlays').show();
       ...
       $.ajax({
    url:"{{route('superadmin.careers.update')}}",
    method:"POST",
