...
@section('content')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                              ...
                              <li class="breadcrumb-item active"><a href="{{route('superadmin.aboutus')}}">About Us</a></li>
 ...
 {{ csrf_field() }}
    ...
    <input type="hidden" name="id" id="id" value="{{$aboutus->aboutus_id}}">

       <div class="form-group">
          <label style="">Desc</label>
           <textarea class="form-control" id="desc" name="desc" rows="5" cols="">{!! $aboutus->desc !!}</textarea>
         <small style=" font-weight: 700;"></small>
        </div>
...
$('.overlays').show();
       ...
       $.ajax({
    url:"{{route('superadmin.aboutus.update')}}",
    method:"POST",
